            ...
            <div class="col-md-8 mx-auto">
                ...
                <form action="{{ action('Admin\ProfileController@update') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class=""col-md-10>
                            <textarea class="form-control" class="form-control" name="hobby" value="{{ $profile_form->title }}">
                            </textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class=""col-md-10>
                            <textarea class="form-control" class="form-control" name="introduction" value="{{ $profile_form->title }}">
                            </textarea>    
                        </div>
                        <div class="form-group row">
                        <div class="col-md-10">
